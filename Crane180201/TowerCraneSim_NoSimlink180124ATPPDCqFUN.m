...
% epsilon = 0.2;
    ...
    [S1,U1,maxerr,meanerr]=TPtransformaiton(gridsize1,lpvux,dep1,domain1,hull,svtol, keep,chebfextrema);
    phi = 1;
    ind=0;
...
%%%%%%%%%%%%%%%%%%%%%%
function [S1,U1,maxerr,meanerr]=TPtransformaiton(gridsize1,lpvux,dep1,domain1,hull,svtol, keep,chebfextrema)
%% TP transformation, same as:
    %   [S U] = tptrans(lpv, dep1, domain, gridsize, 'close');
    % sampling
  
    lpvdata1 =sampling_lpvextrema(lpvux, dep1, domain1, gridsize1,chebfextrema);
