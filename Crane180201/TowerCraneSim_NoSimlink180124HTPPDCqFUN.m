function ParaStruct=HTTPPDCMain()
%% HTPPDC ¸ú×Ù¿ØÖÆÆ÷
% 2018-01-26
clc
clear
...
% epsilon = 0.2;
    ...
    [S1,U1,maxerr,meanerr]=TPtransformaiton(gridsize1,lpvux,dep1,domain1,hull,svtol, keep,primebase,pbaseindx);
    phi = 1;
    ind=0;
    ...
    Hnamemat=strcat('ParaStructDataH',num2str(TP.siz),'.mat');
    save(Hnamemat,'ParaStruct')
    load(Hnamemat,'ParaStruct')
